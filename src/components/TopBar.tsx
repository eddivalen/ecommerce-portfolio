    ...
    <Box bg="black" w="100%" p={2}>
      <Container as={Flex} color="white" justifyContent="space-between" fontSize="xs" size="lg">
        <Flex gap="1.5rem">
          ...
          <Flex display={{base: 'none', sm:'flex'}} as={Link} href="#" alignItems="center" gap="0.5rem"><EmailIcon /> Ukraine, Kyiv, Khreschtayk 1</Flex>
      
          <Flex display={{base: 'none', sm:'flex'}} as={Link} href="#" alignItems="center" gap="0.5rem"><CalendarIcon /> All week 24/7</Flex>
        </Flex>
        <Flex gap="1rem">
